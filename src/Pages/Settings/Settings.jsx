...
const Settings = () => {
  ...
  //       console.log("Uploading file:", profile.profilePicture);

  //       const formData = new FormData();
  //       formData.append("image", profile.profilePicture);

  //       const response = await api.put(
  //         `/admin/upload-profile-picture/${profile._id}`,
  //         formData,
  //         {
  //           headers: {
  ...
  //       console.log("🟡 File selected for upload:", profile.profilePicture);

  //       // Step 2: Create FormData and append the image
  //       const formData = new FormData();
  //       formData.append("image", profile.profilePicture);
  //       console.log("📦 FormData created with image.", formData);

  //       // Step 3: Make API call to upload image
  //       const response = await api.put(
  //         `/admin/upload-profile-picture/${profile._id}`,
  //         formData,
  //         {
  ...
  //       // Step 4: Log success and alert user
  //       console.log("✅ Upload successful. Server response:", response.data);
  //       alert("Profile picture uploaded successfully!");

  //       // Optionally update state with returned image path
  //       setProfile((prev) => ({
  //         ...prev,
  //         image: response.data.data.image,
  //       }));
  //     } catch (error) {
  //       // Step 5: Handle errors and log detailed info
